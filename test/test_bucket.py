"""Bucket anchors — the forward physics + measurement-noise injection the paper's
regime-reversal claim rests on.

Why this file exists: `src/utils/bucket.py` had **zero** test coverage (17 statements, 0
executed — not even imported by the suite) while being the mechanism behind the headline
claim.
