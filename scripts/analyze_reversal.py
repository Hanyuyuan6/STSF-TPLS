...
Aggregates the measurement-noise grid into a per-(dataset, SNR) reversal summary:
...
Provenance: this is the repo edition of the released reversal-analysis script.
...
def add(dataset, arm, seed, snr, ns, fg_pct):
    ...
    # a genuine sub-1% collapse (e.g. a 0.7% fg-mIoU reading) must stay 0.7, not become 70.
...
#        'noise_eval' (full-ref calibration-cliff artifact family) + deprecated 'train_noisy'. ---
