"""Recompute the paper's measurement-to-reconstruction noise amplification diagnostic."""
...
def main():
    ...
    seed_group.add_argument(
        ...
        help="independent noise seeds (default: 1 2 3, matching Supplement Eq. 7)",
    )
    seed_group.add_argument(
    ...
    payload = {
        ...
        "metric_definition": {
            ...
            "equation7_ratio": "sqrt(M) / N * R_IF / R_TA",
            ...
            "equation7_scope": "paper's first-order orthogonal-row approximation; realized linear and post-normalization shifts are also reported",
        },
