...
def _metrics_from_cm(cm):
    ...
    # foreground-only (protocol B, background class 0 dropped): with a sparse foreground the background IoU of ~0.99 inflates the 2-class mean, so read the foreground value
