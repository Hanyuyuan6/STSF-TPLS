...
# ============================================================================
# Utilities  — ⚠️ SHARED TAIL, duplicated verbatim from src/models/gru_unetpp.py
#    (_compute_seq_len · _build_adaptive_upsample · _init_weights · the ms_enhance/attn/aux/UNet++ tail).
#    This model's lift='attn' path must stay numerically identical to GRUUNetPP so the lift ablation
#    (paper Table II) is fair. EDIT BOTH FILES TOGETHER — a silent divergence biases the ablation.
